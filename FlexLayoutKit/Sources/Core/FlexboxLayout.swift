...
public protocol FlexboxLayout: FlexboxView {
    ...
    func padding(_ edge: UEdge, _ length: CGFloat) -> Self
    func padding(_ edge: [UEdge], _ length: CGFloat) -> Self
    
    func padding(_ percent: FlexPercent) -> Self
    func padding(_ edge: UEdge, _ percent: FlexPercent) -> Self
    func padding(_ edge: [UEdge], _ percent: FlexPercent) -> Self
    ...
    func margin(_ edge: UEdge, _ length: CGFloat) -> Self
    func margin(_ edge: [UEdge], _ length: CGFloat) -> Self
    ...
    func margin(_ edge: UEdge, _ percent: FlexPercent) -> Self
    func margin(_ edge: [UEdge], _ percent: FlexPercent) -> Self

    func borderWidth(_ all: CGFloat) -> Self
    func borderWidth(_ edge: UEdge, _ length: CGFloat) -> Self
...
public extension FlexboxLayout {
    ...
    @discardableResult func padding(_ edge: UEdge = .all, _ length: CGFloat) -> Self {
    ...
    @discardableResult func padding(_ edge: UEdge = .all, _ percent: FlexPercent) -> Self {
    ...
    @discardableResult func padding(_ edge: [UEdge], _ length: CGFloat) -> Self {
        edge.forEach {
            _ = padding($0, length)
        }
        return self
    ...
    @discardableResult func padding(_ edge: [UEdge], _ percent: FlexPercent) -> Self {
        edge.forEach {
            _ = padding($0, percent)
        }
        return self
    ...
    @discardableResult func margin(_ edge: UEdge = .all, _ percent: FlexPercent) -> Self {
        let value = YGValue(value:Float(percent.value),unit: .percent)
        switch edge {
    ...
    @discardableResult func margin(_ edge: UEdge = .all, _ length: CGFloat) -> Self {
        let value = YGValue(length)
        switch edge {
        case .all: yoga.margin = value
        case .left: yoga.marginLeft = value
    ...
    @discardableResult func margin(_ edge: [UEdge], _ length: CGFloat) -> Self {
        edge.forEach {
            _ = margin($0, length)
        }
        return self
    ...
    @discardableResult func margin(_ edge: [UEdge], _ percent: FlexPercent) -> Self{
        edge.forEach {
            _ = margin($0, percent)
        }
        return self
    ...
    @discardableResult func borderWidth(_ edge: UEdge, _ length: CGFloat) -> Self {
        switch edge {
...
public extension FlexboxLayout where Self: YGLayout {
    // 属性
    var yoga: YGLayout {
        return self
    }
